...
public class SpringIndicator extends FrameLayout {
	...
	private int textColorId;// 指示器上每个tab的文本颜色
    ...
    private void initAttrs(AttributeSet attrs){
		...
		TypedArray a = getContext().obtainStyledAttributes(attrs,
				AllCanshu.SpringIndicator);
		textColorId = a.getResourceId(AllCanshu.SpringIndicator_siTextColor,
				textColorId);
		selectedTextColorId = a.getResourceId(
				AllCanshu.SpringIndicator_siSelectedTextColor,
				selectedTextColorId);
		textSize = a.getDimension(AllCanshu.SpringIndicator_siTextSize,
				textSize);
		textBgResId = a.getResourceId(AllCanshu.SpringIndicator_siTextBg, 0);
		indicatorColorId = a.getResourceId(
				AllCanshu.SpringIndicator_siIndicatorColor, indicatorColorId);
		indicatorColorsId = a.getResourceId(
				AllCanshu.SpringIndicator_siIndicatorColors, 0);
		radiusMax = a.getDimension(AllCanshu.SpringIndicator_siRadiusMax,
				radiusMax);
		radiusMin = a.getDimension(AllCanshu.SpringIndicator_siRadiusMin,
				radiusMin);
        a.recycle();
