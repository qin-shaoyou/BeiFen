	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!str.equals("yes")) {
			...
			Toast.makeText(ManagerCityActivity.this, "长按城市可进入编辑模式~(☆_☆)", 1)
					.show();
			Toast.makeText(ManagerCityActivity.this, "长按城市可进入编辑模式吆~⊙﹏⊙‖∣", 1)
					.show();
			Toast.makeText(ManagerCityActivity.this, "长按咩~(^o^)", 1).show();
			Toast.makeText(ManagerCityActivity.this, "长按真的能编辑呀~(>^ω^<)", 1)
					.show();
			Toast.makeText(ManagerCityActivity.this, "按住城市●▽●", 1).show();
			Toast.makeText(ManagerCityActivity.this, "按住城市●▽● 可进入编辑模式", 1)
					.show();
			Toast.makeText(ManagerCityActivity.this, "右上角的按钮也可以吆(⊙０⊙)", 1)
					.show();
		}
