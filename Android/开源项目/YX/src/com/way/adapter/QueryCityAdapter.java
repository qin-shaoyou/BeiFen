...
public class QueryCityAdapter extends BaseAdapter implements Filterable {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ViewHolder holder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.city_query_list_item,
					parent, false);
			...
			holder.quhaoTv = (TextView) convertView.findViewById(R.id.quhao);
		...
		holder.quhaoTv.setText("区号:" + city.getPhoneCode());
		return convertView;
	}
